...
- ✅ 02-solution-upgrade: Migrer les deux projets vers .NET 10 et corriger les incompatibilités ([Content](tasks/02-solution-upgrade/task.md), [Progress](tasks/02-solution-upgrade/progress-details.md))
