...
/// <summary>
/// Provides regular-expression patterns used by the Markdown converter.
/// </summary>
internal static class MarkdownPatterns
{
    /// <summary>Gets the ATX heading pattern.</summary>
    public const string Heading = @"^(#{1,6})\s+(.+)$";

    /// <summary>Gets the unordered-list item pattern.</summary>
    public const string UnorderedItem = @"^[-*+]\s+";

    /// <summary>Gets the ordered-list item pattern.</summary>
    public const string OrderedItem = @"^\d+\.\s+";

    /// <summary>Gets the image pattern.</summary>
    public const string Image = @"!\[([^]]*)\]\(([^ )]+)\)";

    /// <summary>Gets the link pattern.</summary>
    public const string Link = @"\[([^]]+)\]\(([^ )]+)\)";

    /// <summary>Gets the inline-code pattern.</summary>
    public const string InlineCode = @"`([^`]+)`";

    /// <summary>Gets the bold pattern.</summary>
    public const string Bold = @"\*\*([^*]+)\*\*|__([^_]+)__";

    /// <summary>Gets the strikethrough pattern.</summary>
    public const string Strikethrough = @"~~([^~]+)~~";

    /// <summary>Gets the encoded underline-tag pattern.</summary>
    public const string Underline = @"&lt;(/?u)&gt;";

    /// <summary>Gets the emphasis pattern.</summary>
